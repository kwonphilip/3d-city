...
export default defineStyle({
  ...
  waterMaterial: new THREE.MeshBasicMaterial({ color: new THREE.Color('#a8d3eb'), transparent: true, opacity: 0.3 }),
  landMaterial: new THREE.MeshBasicMaterial({ color: new THREE.Color('#efe9da'), transparent: true, opacity: 0.3 }),
  parkMaterial: new THREE.MeshBasicMaterial({ color: new THREE.Color('#bfdcae'), transparent: true, opacity: 0.8 }),
